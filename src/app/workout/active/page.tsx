  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="sticky top-0 z-50 px-4 pt-12 pb-2 relative overflow-hidden">
        ...
        <div className="relative flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <Button
              ...
              className="bg-white text-sky-600 hover:bg-gray-100 h-7 text-xs px-2"
            >
        ...
        {/* Timer Bar */}
        <div className="relative flex items-center justify-between bg-white/10 rounded-xl p-2.5 sm:p-3 mb-2">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] sm:text-xs text-white/70">Duration</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            >
              {workoutTimer.isRunning ? <Pause className="w-4 h-4" /> : <Play className="w-4 h-4" />}
            </Button>
            <Button
              size="icon"
              variant="ghost"
              onClick={() => setShowNotesDialog(true)}
              className={cn("text-white hover:bg-white/20 h-8 w-8", workoutNotes && "bg-white/20")}
            >
            ...
            <Button
              ...
              variant="ghost"
              onClick={() => setShowRestSettings(true)}
              className="text-white hover:bg-white/20 gap-1 px-1.5 h-8"
            >
              <Timer className="w-3.5 h-3.5" />
              <span className="text-[10px] sm:text-xs font-mono">{autoRestEnabled ? `${defaultRestTime}s` : 'Off'}</span>
            </Button>
          </div>
          ...
          <div className="text-right">
            ...
            <p className="text-[10px] sm:text-xs text-white/70">Sets done</p>
          </div>
        </div>
      ...
      <div className="sticky top-[168px] z-40 bg-slate-800 backdrop-blur border-b border-slate-700 px-3 sm:px-4 py-2">
        <div className="flex items-center gap-1.5 sm:gap-2">
          <span className="text-[10px] sm:text-xs text-slate-400 mr-1 sm:mr-2">Add:</span>
          ...
          <Button
            ...
            className="h-8 px-2 sm:px-3 gap-1 hover:bg-orange-500/10 text-orange-400/70 hover:text-orange-400"
          >
          ...
          <Button
            ...
            className="h-8 px-2 sm:px-3 gap-1 hover:bg-green-500/10 text-green-400/70 hover:text-green-400"
          >
          ...
          <Button
            ...
            className="h-8 px-2 sm:px-3 gap-1 hover:bg-slate-700 text-slate-400 ml-auto"
          >
            <Plus className="w-3 h-3" />
            <span className="text-[10px]">Add Exercise</span>
          </Button>
        </div>
      </div>
      ...
      <Dialog open={showExerciseModal} onOpenChange={(open) => {
        ...
        <DialogContent className="bg-white border-gray-200 max-w-lg max-h-[85vh]">
          <DialogHeader>
            ...
            {!activeBlockId && (
              <>
                <DialogTitle className="text-gray-900">Add Exercise</DialogTitle>
