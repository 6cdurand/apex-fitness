/**
 * Tests for the messaging D1 + D2 fixes.
 *
 ...
 * shim BEFORE importing the module. This lets us exercise the exported pure
 * helpers without spinning up a fake DOM or mocking Supabase.
 */
